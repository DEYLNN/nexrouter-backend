...
export const APIKEY_PROVIDERS = {
  ...
  cavoti: { id: "cavoti", alias: "cv", name: "Cavoti", icon: "/providers/cavoti.svg", color: "#10B981", textIcon: "CV", website: "https://cavoti.com", notice: { text: "OpenAI-compatible inference API via cavoti.com/v1.", apiKeyUrl: "https://cavoti.com" }, serviceKinds: ["llm"], models: [{ id: "gpt-5.5", name: "GPT-5.5" }] },
