...
export const APIKEY_PROVIDERS = {
  ...
  unimodel: { id: "unimodel", alias: "um", name: "Unimodel", icon: "/providers/unimodel.jpg", color: "#8B5CF6", textIcon: "UM", website: "https://unimodel.ai", notice: { text: "OpenAI-compatible inference API via unimodel.ai/v1.", apiKeyUrl: "https://unimodel.ai" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://unimodel.ai/v1/models", type: "openai" } },
