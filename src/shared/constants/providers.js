...
export const APIKEY_PROVIDERS = {
  ...
  zyloo: { id: "zyloo", alias: "zyloo", name: "Zyloo", icon: "/providers/zyloo.png", color: "#111827", textIcon: "ZY", website: "https://zyloo.io", notice: { text: "OpenAI-compatible Zyloo endpoint. Add your Zyloo API key.", apiKeyUrl: "https://zyloo.io" }, serviceKinds: ["llm"], models: [{ id: "claude-opus-4-6", name: "Claude Opus 4.6 (Free)" }, { id: "gpt-5.4", name: "GPT 5.4 (Free)" }, { id: "deepseek-r1", name: "DeepSeek R1 (Free)" }, { id: "claude-opus-4-8", name: "Claude Opus 4.8" }, { id: "claude-opus-4-7", name: "Claude Opus 4.7" }, { id: "claude-opus-4-5-20251101", name: "Claude Opus 4.5" }, { id: "claude-opus-4-1-20250805", name: "Claude Opus 4.1" }, { id: "claude-sonnet-4-5-20250929", name: "Claude Sonnet 4.5" }, { id: "gpt-5.5", name: "GPT 5.5" }, { id: "gpt-5.4-pro", name: "GPT 5.4 Pro" }, { id: "gpt-5.4-mini", name: "GPT 5.4 Mini" }, { id: "gpt-5.4-nano", name: "GPT 5.4 Nano" }, { id: "gpt-5.3-chat-latest", name: "GPT 5.3 Chat Latest" }, { id: "gpt-5.3-codex", name: "GPT 5.3 Codex" }, { id: "gpt-5.2", name: "GPT 5.2" }, { id: "gpt-5.2-pro", name: "GPT 5.2 Pro" }, { id: "gpt-5.2-chat", name: "GPT 5.2 Chat" }, { id: "gpt-5.2-codex", name: "GPT 5.2 Codex" }, { id: "gpt-5.1", name: "GPT 5.1" }, { id: "gpt-5.1-chat-latest", name: "GPT 5.1 Chat Latest" }, { id: "gpt-5.1-codex", name: "GPT 5.1 Codex" }, { id: "gpt-5", name: "GPT 5" }, { id: "gpt-5-pro", name: "GPT 5 Pro" }, { id: "gpt-5-mini", name: "GPT 5 Mini" }, { id: "gpt-5-nano", name: "GPT 5 Nano" }, { id: "gpt-5-codex", name: "GPT 5 Codex" }, { id: "deepseek-r1-0528", name: "DeepSeek R1 0528" }, { id: "deepseek-r1-250528", name: "DeepSeek R1 250528" }, { id: "deepseek-r1-searching", name: "DeepSeek R1 Searching" }, { id: "deepseek-v3", name: "DeepSeek V3" }, { id: "deepseek-v3.1", name: "DeepSeek V3.1" }, { id: "deepseek-reasoner", name: "DeepSeek Reasoner" }, { id: "kimi-k2.6", name: "Kimi K2.6" }, { id: "kimi-k2.5", name: "Kimi K2.5" }, { id: "kimi-k2-instruct", name: "Kimi K2 Instruct" }, { id: "grok-4", name: "Grok 4" }, { id: "grok-4.1", name: "Grok 4.1" }, { id: "grok-4-fast", name: "Grok 4 Fast" }, { id: "grok-4-fast-reasoning", name: "Grok 4 Fast Reasoning" }, { id: "qwen3-max", name: "Qwen3 Max" }, { id: "qwen3.7-max", name: "Qwen3.7 Max" }, { id: "qwen3-coder-plus", name: "Qwen3 Coder Plus" }, { id: "qwen3-coder-480b-a35b-instruct", name: "Qwen3 Coder 480B A35B Instruct" }, { id: "glm-5.1", name: "GLM 5.1" }, { id: "glm-5", name: "GLM 5" }, { id: "glm-4.7", name: "GLM 4.7" }, { id: "MiniMax-M2.5", name: "MiniMax M2.5" }, { id: "minimax-m2.1", name: "Minimax M2.1" }], modelsFetcher: { url: "https://zyloo.io/v1/models", type: "openai" } },
