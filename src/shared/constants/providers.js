...
export const APIKEY_PROVIDERS = {
  ...
  husada: { id: "husada", alias: "husada", name: "Husada", icon: "/providers/husada.jpg", color: "#10B981", textIcon: "HS", website: "https://husada.net", notice: { text: "OpenAI-compatible Husada endpoint.", apiKeyUrl: "https://husada.net" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://husada.net/v1/models", type: "openai" } },
  ...
  ocenza: { id: "ocenza", alias: "ocenza", name: "Ocenza", icon: "/providers/ocenza.jpg", color: "#0EA5E9", textIcon: "OZ", website: "https://ocenza.com", notice: { text: "OpenAI-compatible Ocenza endpoint.", apiKeyUrl: "https://ocenza.com" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://ocenza.com/v1/models", type: "openai" } },
  anuma: { id: "anuma", alias: "anuma", name: "Anuma", icon: "api", color: "#7C3AED", textIcon: "AN", website: "https://portal.anuma.ai", notice: { text: "Masukkan EVM User ID/address. NexRouter memakai X-API-KEY Anuma fixed dari server env.", apiKeyUrl: "https://portal.anuma.ai" }, serviceKinds: ["llm"] },
  ...
  openmodal: { id: "openmodal", alias: "om", name: "OpenModal", icon: "/providers/openmodal.jpg", color: "#6366F1", textIcon: "OM", website: "https://openmodel.ai", notice: { text: "Anthropic-compatible /v1/messages endpoint. Supports DeepSeek V4 Flash.", apiKeyUrl: "https://openmodel.ai" }, serviceKinds: ["llm"], models: [{ id: "deepseek-v4-flash", name: "DeepSeek V4 Flash", targetFormat: "claude" }] },
  "badtheory-labs-2": { id: "badtheory-labs-2", alias: "btl2", name: "Badtheory Labs 2", icon: "science", color: "#8B5CF6", textIcon: "B2", website: "https://badtheorylabs.com", notice: { text: "Badtheory Labs (polos, no mods). Add your BTL API key.", apiKeyUrl: "https://badtheorylabs.com" }, serviceKinds: ["llm"], models: [{ id: "claude-sonnet-4-5", name: "Claude Sonnet 4.5" }, { id: "claude-4.1-opus-20250805", name: "Claude 4.1 Opus" }, { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6" }, { id: "claude-4.5-haiku-20251001", name: "Claude 4.5 Haiku" }, { id: "claude-opus-4-5", name: "Claude Opus 4.5" }, { id: "claude-opus-4-6", name: "Claude Opus 4.6" }, { id: "claude-4-opus-20250522", name: "Claude 4 Opus" }, { id: "claude-haiku-4-5", name: "Claude Haiku 4.5" }, { id: "deepseek-v4-pro", name: "DeepSeek V4 Pro" }, { id: "gpt-5-5", name: "GPT 5.5" }, { id: "laguna-m.1-20260312", name: "Laguna M.1" }, { id: "btl-2", name: "BTL 2" }, { id: "gpt-4o-mini", name: "GPT 4o Mini" }, { id: "claude-4-sonnet-20250522", name: "Claude 4 Sonnet" }, { id: "free", name: "Free" }, { id: "gemma-4-26b-a4b-it", name: "Gemma 4 26B" }, { id: "laguna-xs.2-20260421", name: "Laguna XS.2" }, { id: "lfm-2.5-1.2b-thinking-20260120", name: "LFM 2.5 Thinking" }, { id: "lfm-2.5-1.2b-instruct-20260120", name: "LFM 2.5 Instruct" }, { id: "nemotron-nano-12b-v2-vl", name: "Nemotron Nano 12B V2" }, { id: "gemma-4-31b-it", name: "Gemma 4 31B" }, { id: "nemotron-3.5-content-safety-20260604", name: "Nemotron 3.5 Safety" }, { id: "deepseek-v4-flash", name: "DeepSeek V4 Flash" }, { id: "gpt-4.1-mini", name: "GPT 4.1 Mini" }, { id: "gpt-5.4-mini", name: "GPT 5.4 Mini" }, { id: "nemotron-3-nano-omni-30b-a3b-reasoning-20260428", name: "Nemotron 3 Nano Omni" }, { id: "gpt-5.4", name: "GPT 5.4" }, { id: "gpt-4.1-nano", name: "GPT 4.1 Nano" }, { id: "gpt-4.1", name: "GPT 4.1" }, { id: "claude-opus-4-7", name: "Claude Opus 4.7" }, { id: "gemma-4-31b-it-20260402", name: "Gemma 4 31B V2" }, { id: "claude-opus-4-8", name: "Claude Opus 4.8" }, { id: "nemotron-nano-9b-v2", name: "Nemotron Nano 9B V2" }, { id: "owl-alpha", name: "Owl Alpha" }] },
  ...
  "alibaba-studio": { id: "alibaba-studio", alias: "alistudio", name: "Alibaba Studio", icon: "/providers/alibaba-studio.png", color: "#FF6A00", textIcon: "ALi", website: "https://modelstudio.console.alibabacloud.com", notice: { text: "Alibaba Cloud Model Studio compatible-mode endpoint.", apiKeyUrl: "https://modelstudio.console.alibabacloud.com/?apiKey=1" } },
