...
export const APIKEY_PROVIDERS = {
  ...
  "cline-apikey": { id: "cline-apikey", alias: "cl-ak", name: "Cline API Key", icon: "smart_toy", color: "#5B9BD5", textIcon: "CL", website: "https://cline.bot", notice: { apiKeyUrl: "https://cline.bot", text: "Enter your Cline API key (sk_...). Uses https://api.cline.bot/api/v1/chat/completions." }, serviceKinds: ["llm"] },
