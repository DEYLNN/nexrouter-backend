...
export const APIKEY_PROVIDERS = {
  ...
  anuma: { id: "anuma", alias: "anuma", name: "Anuma", icon: "api", color: "#7C3AED", textIcon: "AN", website: "https://portal.anuma.ai", notice: { text: "Anuma OpenAI-format endpoint with custom X-API-KEY + X-User-ID headers.", apiKeyUrl: "https://portal.anuma.ai" }, serviceKinds: ["llm"] },
