...
export const APIKEY_PROVIDERS = {
  ...
  ftstoresz: { id: "ftstoresz", alias: "ftstoresz", name: "ftstoresz", icon: "storefront", color: "#0EA5E9", textIcon: "FT", website: "https://api-ai.ftstoresz.com", notice: { text: "OpenAI-compatible ftstoresz endpoint. Add your ftstoresz API key.", apiKeyUrl: "https://api-ai.ftstoresz.com" }, serviceKinds: ["llm"], models: [{ id: "qwen3.7-max", name: "Qwen3.7 Max" }, { id: "claude-opus-4.7", name: "Claude Opus 4.7" }] },
