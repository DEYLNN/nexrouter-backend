...
export const OAUTH_PROVIDERS = {
  ...
  kilocode: { id: "kilocode", alias: "kc", name: "Kilo Code", icon: "code", color: "#FF6B35", textIcon: "KC", website: "https://kilocode.ai", notice: { signupUrl: "https://kilocode.ai" }, models: [{ id: "poolside/laguna-m.1:free", name: "Poolside Laguna M.1 Free" }, { id: "google/gemma-4-26b-a4b-it:free", name: "Google Gemma 4 26B Free" }, { id: "inclusionai/ling-2.6-1t:free", name: "InclusionAI Ling 2.6 1T Free" }, { id: "inclusionai/ling-2.6-flash:free", name: "InclusionAI Ling 2.6 Flash Free" }, { id: "nvidia/nemotron-3-super-120b-a12b:free", name: "NVIDIA Nemotron 3 Super 120B Free" }, { id: "tencent/hy3-preview:free", name: "Tencent HY3 Preview Free" }, { id: "stepfun/step-3.7-flash:free", name: "StepFun Step 3.7 Flash Free" }] },
