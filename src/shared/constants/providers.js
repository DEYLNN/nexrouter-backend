...
export const APIKEY_PROVIDERS = {
  ...
  "badtheory-labs": { id: "badtheory-labs", alias: "btl", name: "Badtheory Labs", icon: "science", color: "#8B5CF6", textIcon: "BT", website: "https://badtheorylabs.com", notice: { text: "OpenAI-compatible Badtheory Labs endpoint. Add your BTL API key.", apiKeyUrl: "https://badtheorylabs.com" }, serviceKinds: ["llm"], models: [{ id: "deepseek-v4-flash", name: "DeepSeek V4 Flash" }, { id: "deepseek-v4-pro", name: "DeepSeek V4 Pro" }] },
