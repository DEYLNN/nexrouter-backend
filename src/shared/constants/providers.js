...
export const APIKEY_PROVIDERS = {
  ...
  "alicloud-modelstudio": { id: "alicloud-modelstudio", alias: "alims", name: "Alibaba Model Studio", icon: "cloud", color: "#FF6A00", textIcon: "AMS", website: "https://modelstudio.console.alibabacloud.com", notice: { text: "Alibaba Cloud Model Studio compatible-mode endpoint.", apiKeyUrl: "https://modelstudio.console.alibabacloud.com/?apiKey=1" } },
