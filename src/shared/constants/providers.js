...
export const APIKEY_PROVIDERS = {
  ...
  axumrouter: { id: "axumrouter", alias: "axm", name: "AxumRouter", icon: "router", color: "#2563EB", textIcon: "AX", website: "http://152.42.198.51:3000", notice: { text: "OpenAI-compatible AxumRouter endpoint.", apiKeyUrl: "http://152.42.198.51:3000" }, serviceKinds: ["llm"], models: [{ id: "mistral/mistral-small-latest", name: "Mistral Small" }] },
