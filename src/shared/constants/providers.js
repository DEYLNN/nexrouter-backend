...
export const APIKEY_PROVIDERS = {
  ...
  zenmux: { id: "zenmux", alias: "zmx", name: "Zenmux", icon: "/providers/zenmux.png", color: "#7C3AED", textIcon: "ZX", website: "https://zenmux.ai", notice: { text: "OpenAI-compatible Zenmux endpoint.", apiKeyUrl: "https://zenmux.ai" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://zenmux.ai/api/v1/models", type: "openai" } },
