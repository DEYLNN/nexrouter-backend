...
export const FREE_TIER_PROVIDERS = {
  ...
  sambanova: { id: "sambanova", alias: "sambanova", name: "SambaNova", icon: "/provider-icons/sambanova.png", color: "#7C3AED", textIcon: "SN", website: "https://cloud.sambanova.ai", notice: { text: "Developer free tier; OpenAI-compatible endpoint.", apiKeyUrl: "https://cloud.sambanova.ai/apis" }, serviceKinds: ["llm"] },
  llm7: { id: "llm7", alias: "llm7", name: "LLM7", icon: "/provider-icons/llm7.png", color: "#0EA5E9", textIcon: "L7", website: "https://llm7.io", notice: { text: "OpenAI-compatible aggregator with free plan; add your LLM7 API key.", apiKeyUrl: "https://llm7.io" }, serviceKinds: ["llm"] },
...
export const OAUTH_PROVIDERS = {
  ...
  "nous-portal": { id: "nous-portal", alias: "nous", name: "Nous Portal", icon: "psychology", color: "#7C3AED", textIcon: "NO", serviceKinds: ["llm"], website: "https://portal.nousresearch.com", notice: { signupUrl: "https://portal.nousresearch.com" } },
  ...
  kilocode: { id: "kilocode", alias: "kc", name: "Kilo Code", icon: "code", color: "#FF6B35", textIcon: "KC", website: "https://kilocode.ai", notice: { signupUrl: "https://kilocode.ai" }, models: [{ id: "poolside/laguna-m.1:free", name: "Poolside Laguna M.1 Free" }, { id: "google/gemma-4-26b-a4b-it:free", name: "Google Gemma 4 26B Free" }, { id: "inclusionai/ling-2.6-1t:free", name: "InclusionAI Ling 2.6 1T Free" }, { id: "inclusionai/ling-2.6-flash:free", name: "InclusionAI Ling 2.6 Flash Free" }, { id: "nvidia/nemotron-3-super-120b-a12b:free", name: "NVIDIA Nemotron 3 Super 120B Free" }, { id: "nvidia/nemotron-3-ultra-550b-a55b:free", name: "NVIDIA Nemotron 3 Ultra 550B Free" }, { id: "tencent/hy3-preview:free", name: "Tencent HY3 Preview Free" }, { id: "stepfun/step-3.7-flash:free", name: "StepFun Step 3.7 Flash Free" }] },
...
export const APIKEY_PROVIDERS = {
  evomap: { id: "evomap", alias: "evo", name: "Evomap", icon: "/providers/evomap.svg", color: "#111827", textIcon: "EVO", website: "https://evomap.ai", notice: { text: "OpenAI-compatible Evomap endpoint. Add your Evomap API key.", apiKeyUrl: "https://evomap.ai" }, serviceKinds: ["llm"], models: [{ id: "evomap-gemini-3.1-pro-preview", name: "Gemini 3.1 Pro Preview" }, { id: "evomap-deepseek-v4-flash", name: "DeepSeek V4 Flash" }, { id: "evomap-claude-opus-4-7", name: "Claude Opus 4.7" }, { id: "evomap-glm-5.1", name: "GLM 5.1" }, { id: "evomap-gpt-5.5", name: "GPT 5.5" }, { id: "evomap-kimi-k2.6", name: "Kimi K2.6" }] },
  ...
  "naraya-ai": { id: "naraya-ai", alias: "nry", name: "Naraya AI", icon: "/providers/naraya-ai.png", color: "#8B5CF6", textIcon: "NR", website: "https://bynara.id", notice: { text: "Naraya AI OpenAI-compatible endpoint via router.bynara.id.", apiKeyUrl: "https://bynara.id" }, serviceKinds: ["llm"], models: [{ id: "mistral-medium-3-5", name: "Mistral Medium 3.5" }, { id: "mistral-large", name: "Mistral Large" }, { id: "mimo-v2.5-pro-free", name: "MiMo V2.5 Pro Free" }, { id: "mimo-v2.5-free", name: "MiMo V2.5 Free" }], modelsFetcher: { url: "https://router.bynara.id/v1/models", type: "openai" } },
  kimchi: { id: "kimchi", alias: "kim", name: "Kimchi", icon: "/providers/kimchi.jpg", color: "#FF5A3D", textIcon: "KC", website: "https://llm.kimchi.dev", notice: { text: "OpenAI-compatible Kimchi endpoint. Add your Kimchi/CastAI API key.", apiKeyUrl: "https://llm.kimchi.dev" }, serviceKinds: ["llm"] },
  longcat: { id: "longcat", alias: "lc", name: "LongCat", icon: "/providers/longcat.png", color: "#FF8C00", textIcon: "LC", website: "https://longcat.chat", notice: { text: "LongCat OpenAI-compatible endpoint. Add your LongCat API key.", apiKeyUrl: "https://longcat.chat" }, serviceKinds: ["llm"], models: [{ id: "LongCat-2.0-Preview", name: "LongCat 2.0 Preview" }], modelsFetcher: { url: "https://api.longcat.chat/openai/v1/models", type: "openai" } },
  ...
  zyloo: { id: "zyloo", alias: "zyl", name: "Zyloo", icon: "/providers/zyloo.png", color: "#111827", textIcon: "ZY", website: "https://zyloo.io", notice: { text: "OpenAI-compatible Zyloo endpoint. Add your Zyloo API key.", apiKeyUrl: "https://zyloo.io/dashboard" }, serviceKinds: ["llm"], models: [{ id: "zyloo/claude-sonnet-4-6", name: "Claude Sonnet 4.6" }, { id: "zyloo/gpt-5.4", name: "GPT 5.4" },
    { id: "zyloo/deepseek-v4-flash", name: "DeepSeek V4 Flash" }], modelsFetcher: { url: "https://api.zyloo.io/v1/models", type: "openai" } },
  tokenrouter: { id: "tokenrouter", alias: "tr", name: "TokenRouter", icon: "/providers/tokenrouter.jpg", color: "#111827", textIcon: "TR", website: "https://tokenrouter.com", notice: { text: "OpenAI-compatible TokenRouter endpoint. Add your TokenRouter API key.", apiKeyUrl: "https://tokenrouter.com" }, serviceKinds: ["llm"], models: [{ id: "MiniMax-M3", name: "MiniMax M3" }], modelsFetcher: { url: "https://api.tokenrouter.com/v1/models", type: "openai" } },
  zerog: { id: "zerog", alias: "0g", name: "0G Labs", icon: "/providers/0g-labs.jpg", color: "#111827", textIcon: "0G", website: "https://0g.ai", notice: { text: "OpenAI-compatible 0G Labs endpoint. Add your 0G Labs API key.", apiKeyUrl: "https://0g.ai" }, serviceKinds: ["llm"], models: [{ id: "minimax-m3", name: "MiniMax M3" }], modelsFetcher: { url: "https://router-api.0g.ai/v1/models", type: "openai" } },
  morph: { id: "morph", alias: "mrph", name: "Morph LLM", icon: "auto_awesome", color: "#6B4FBB", textIcon: "MP", website: "https://morphllm.com", notice: { apiKeyUrl: "https://morphllm.com/dashboard/api-keys" }, serviceKinds: ["llm", "embedding"], models: [{ id: "morph-dsv4flash", name: "Morph DeepSeek V4 Flash" }], modelsFetcher: { url: "https://api.morphllm.com/v1/models", type: "openai" }, embeddingConfig: { baseUrl: "https://api.morphllm.com/v1/embeddings", authType: "apikey", authHeader: "bearer", models: [{ id: "morph-embedding-v4", name: "Morph Embedding V4", dimensions: 1536 }] } },
  ...
  husada: { id: "husada", alias: "hus", name: "Husada", icon: "/providers/husada.jpg", color: "#10B981", textIcon: "HS", website: "https://husada.net", notice: { text: "OpenAI-compatible Husada endpoint.", apiKeyUrl: "https://husada.net" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://husada.net/v1/models", type: "openai" } },
  zenmux: { id: "zenmux", alias: "zmx", name: "Zenmux", icon: "/providers/zenmux.png", color: "#7C3AED", textIcon: "ZX", website: "https://zenmux.ai", notice: { text: "OpenAI-compatible Zenmux endpoint.", apiKeyUrl: "https://zenmux.ai" }, serviceKinds: ["llm"], models: [{ id: "moonshotai/kimi-k2.7-code-free", name: "Kimi K2.7 Code Free" }, { id: "stepfun/step-3.7-flash-free", name: "Step 3.7 Flash Free" }, { id: "z-ai/glm-5.2-free", name: "GLM 5.2 Free" }, { id: "z-ai/glm-4.7-flash-free", name: "GLM 4.7 Flash Free" }, { id: "z-ai/glm-4.6v-flash-free", name: "GLM 4.6V Flash Free" }], modelsFetcher: { url: "https://zenmux.ai/api/v1/models", type: "openai" } },
  ocenza: { id: "ocenza", alias: "ocz", name: "Ocenza", icon: "/providers/ocenza.jpg", color: "#0EA5E9", textIcon: "OZ", website: "https://ocenza.com", notice: { text: "OpenAI-compatible Ocenza endpoint.", apiKeyUrl: "https://ocenza.com" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://ocenza.com/v1/models", type: "openai" } },
  anuma: { id: "anuma", alias: "anm", name: "Anuma", icon: "api", color: "#7C3AED", textIcon: "AN", website: "https://portal.anuma.ai", notice: { text: "Masukkan EVM User ID/address. NexRouter memakai X-API-KEY Anuma fixed dari server env.", apiKeyUrl: "https://portal.anuma.ai" }, serviceKinds: ["llm"] },
  swiftrouter: { id: "swiftrouter", alias: "sr", name: "SwiftRouter", icon: "bolt", color: "#0EA5E9", textIcon: "SR", website: "https://swiftrouter.com", notice: { text: "OpenAI-compatible API with curated recent and popular models. The /models endpoint requires an API key.", apiKeyUrl: "https://swiftrouter.com" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://api.swiftrouter.com/v1/models", type: "openai" } },
  "gitlawb-mimo": { id: "gitlawb-mimo", alias: "glb-mimo", name: "Gitlawb MiMo", icon: "/provider-icons/gitlawb.png", color: "#111827", textIcon: "GLM", website: "https://gitlawb.com/opengateway", notice: { text: "Gitlawb OpenGateway Xiaomi-MiMo route. Uses ogw_live_ API key and exposes the /v1/xiaomi-mimo catalog including MiniMax M3.", apiKeyUrl: "https://gitlawb.com/opengateway/dashboard" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://opengateway.gitlawb.com/v1/xiaomi-mimo/models", type: "openai" } },
  gitlawb: { id: "gitlawb", alias: "glb", name: "Gitlawb", icon: "/provider-icons/gitlawb.png", color: "#111827", textIcon: "GLB", website: "https://gitlawb.com/opengateway", notice: { text: "Gitlawb Opengateway now requires an ogw_live_ API key.", apiKeyUrl: "https://gitlawb.com/opengateway/dashboard" }, serviceKinds: ["llm"], passthroughModels: true, modelsFetcher: { url: "https://opengateway.gitlawb.com/v1/models", type: "openai" } },
  "qwen-cloud": { id: "qwen-cloud", alias: "qc", name: "Qwen Cloud", icon: "/providers/qwencloud.png", color: "#1677FF", textIcon: "QC", website: "https://dashscope.console.aliyun.com", notice: { text: "Alibaba Cloud Qwen model inference API (dashscope-intl). OpenAI-compatible.", apiKeyUrl: "https://dashscope.console.aliyun.com/apiKey" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1/models", type: "openai" } },
  vikey: { id: "vikey", alias: "vk", name: "Vikey", icon: "/providers/vikey.svg", color: "#6366F1", textIcon: "VK", website: "https://vikey.ai", notice: { text: "Indonesian AI inference API. Pay-as-you-go IDR pricing. OpenAI + Anthropic compatible.", apiKeyUrl: "https://vikey.ai/dashboard" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://api.vikey.ai/v1/models", type: "openai" } },
  unimodel: { id: "unimodel", alias: "um", name: "Unimodel", icon: "/providers/unimodel.jpg", color: "#8B5CF6", textIcon: "UM", website: "https://unimodel.ai", notice: { text: "OpenAI-compatible inference API via unimodel.ai/v1.", apiKeyUrl: "https://unimodel.ai" }, serviceKinds: ["llm"], models: [{ id: "deepseek-v4-pro", name: "DeepSeek V4 Pro" }, { id: "deepseek-v4-flash", name: "DeepSeek V4 Flash" }, { id: "glm-5.2", name: "GLM 5.2" }, { id: "glm-5.1", name: "GLM 5.1" }] },
  "nabz-clan": { id: "nabz-clan", alias: "nzc", name: "Nabz Clan", icon: "/providers/nabz-clan.jpg", color: "#FF6B35", textIcon: "NZ", website: "https://lumyx-ai.site", notice: { text: "OpenAI-compatible inference API via lumyx-ai.site.", apiKeyUrl: "https://lumyx-ai.site" }, serviceKinds: ["llm"], models: [{ id: "minimax-m3", name: "MiniMax M3" }] },
  axumrouter: { id: "axumrouter", alias: "axm", name: "AxumRouter", icon: "router", color: "#2563EB", textIcon: "AX", website: "http://152.42.198.51:3000", notice: { text: "OpenAI-compatible AxumRouter endpoint.", apiKeyUrl: "http://152.42.198.51:3000" }, serviceKinds: ["llm"], models: [{ id: "mst/mistral-small-latest", name: "Mistral Small" }] },
  questflow: { id: "questflow", alias: "qf", name: "Questflow", icon: "/providers/questflow.png", color: "#0E9384", textIcon: "QF", website: "https://app.questflow.ai", notice: { text: "OpenAI-compatible inference API via app.questflow.ai/openapi/v1.", apiKeyUrl: "https://app.questflow.ai" }, serviceKinds: ["llm"], models: [{ id: "gpt-4o-mini", name: "GPT-4o Mini" }], modelsFetcher: { url: "https://app.questflow.ai/openapi/v1/models", type: "openai" } },
  cavoti: { id: "cavoti", alias: "cv", name: "Cavoti", icon: "/providers/cavoti.png", color: "#10B981", textIcon: "CV", website: "https://cavoti.com", notice: { text: "OpenAI-compatible Responses API via cavoti.com/v1.", apiKeyUrl: "https://cavoti.com" }, serviceKinds: ["llm"], models: [{ id: "gpt-5.5", name: "GPT-5.5" }] },
  conduit: { id: "conduit", alias: "co", name: "Conduit Ozdoev", icon: "/providers/conduit.jpg", color: "#0EA5E9", textIcon: "CO", website: "https://conduit.ozdoev.net", notice: { text: "OpenAI-compatible inference API via conduit.ozdoev.net/api/v1.", apiKeyUrl: "https://conduit.ozdoev.net" }, serviceKinds: ["llm"], models: [
  ...
  "babel-town": { id: "babel-town", alias: "bt", name: "Babel Town", icon: "cloud", color: "#8B5CF6", textIcon: "BT", website: "https://babel.town", notice: { text: "OpenAI-compatible inference API.", apiKeyUrl: "https://babel.town" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://api.babel.town/v1/models", type: "openai" } },
  "gmi-cloud": { id: "gmi-cloud", alias: "gmi", name: "GMI Cloud", icon: "/provider-icons/gmi-cloud.jpg", color: "#0EA5E9", textIcon: "GMI", website: "https://www.gmicloud.ai", notice: { text: "OpenAI-compatible API via GMI Serving.", apiKeyUrl: "https://api.gmi-serving.com" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://api.gmi-serving.com/v1/models", type: "openai" } },
  canopywave: { id: "canopywave", alias: "cwv", name: "CanopyWave", icon: "cloud", color: "#15B8A6", textIcon: "CW", website: "https://canopywave.io", notice: { text: "Free-tier OpenAI-compatible inference endpoint. Supports MiMo and Kimi models.", apiKeyUrl: "https://canopywave.io" }, serviceKinds: ["llm"] },
  openmodal: { id: "openmodal", alias: "om", name: "OpenModel", icon: "/providers/openmodal.jpg", color: "#6366F1", textIcon: "OM", website: "https://openmodel.ai", notice: { text: "Anthropic-compatible /v1/messages endpoint. Supports DeepSeek V4 Flash.", apiKeyUrl: "https://openmodel.ai" }, serviceKinds: ["llm"], models: [{ id: "deepseek-v4-flash", name: "DeepSeek V4 Flash", targetFormat: "claude" }] },
  "badtheory-labs": { id: "badtheory-labs", alias: "btl", name: "Badtheory Labs", icon: "/provider-icons/btl.jpg", color: "#8B5CF6", textIcon: "BT", website: "https://badtheorylabs.com", notice: { text: "Badtheory Labs (default executor, no mods). Add your BTL API key.", apiKeyUrl: "https://badtheorylabs.com" }, serviceKinds: ["llm"], models: [{ id: "gpt-5-5", name: "GPT 5.5" }, { id: "gpt-5.4", name: "GPT 5.4" }, { id: "gpt-5.4-mini", name: "GPT 5.4 Mini" }, { id: "deepseek-v4-flash", name: "DeepSeek V4 Flash" }, { id: "deepseek-v4-pro", name: "DeepSeek V4 Pro" }] },
  "cline-apikey": { id: "cline-apikey", alias: "cl-ak", name: "Cline", icon: "/providers/cline.png", color: "#5B9BD5", textIcon: "CL", website: "https://cline.bot", notice: { apiKeyUrl: "https://cline.bot", text: "Enter your Cline API key (sk_...). Uses https://api.cline.bot/api/v1/chat/completions." }, serviceKinds: ["llm"] },
  ...
  "alibaba-studio": { id: "alibaba-studio", alias: "als", name: "Alibaba Studio", icon: "/providers/alibaba-studio.png", color: "#FF6A00", textIcon: "ALi", website: "https://modelstudio.console.alibabacloud.com", notice: { text: "Alibaba Cloud Model Studio compatible-mode endpoint.", apiKeyUrl: "https://modelstudio.console.alibabacloud.com/?apiKey=1" } },
  "xiaomi-mimo": { id: "xiaomi-mimo", alias: "mimo", name: "Xiaomi MiMo", icon: "smart_toy", color: "#FF6900", textIcon: "XM", website: "https://xiaomimimo.com", notice: { text: "Credit / pay-as-you-go API endpoint.", apiKeyUrl: "https://platform.xiaomimimo.com" } },
  "xiaomi-mimo-plan-sgp": { id: "xiaomi-mimo-plan-sgp", alias: "mimo-sgp", name: "MIMO Plan SGP", hasProviderSpecificData: true, icon: "smart_toy", color: "#2563EB", textIcon: "MS", website: "https://xiaomimimo.com", notice: { text: "Token Plan Singapore endpoint: token-plan-sgp.xiaomimimo.com/v1. Includes 5 chat/full-modal models + 3 TTS models.", apiKeyUrl: "https://platform.xiaomimimo.com/token-plan" }, serviceKinds: ["llm", "tts"], ttsConfig: { baseUrl: "https://token-plan-sgp.xiaomimimo.com/v1/audio/speech", authType: "apikey", authHeader: "bearer", format: "openai", models: [{ id: "mimo-v2.5-tts", name: "MiMo V2.5 TTS" }, { id: "mimo-v2.5-tts-voiceclone", name: "MiMo V2.5 TTS VoiceClone" }, { id: "mimo-v2.5-tts-voicedesign", name: "MiMo V2.5 TTS VoiceDesign" }] } },
  ...
  agn: { id: "agn", alias: "agn", name: "Agnes AI", icon: "/provider-icons/agnes-ai.png", color: "#8B5CF6", textIcon: "AG", website: "https://agnes-ai.com", notice: { apiKeyUrl: "https://apihub.agnes-ai.com" }, serviceKinds: ["llm"], models: [{ id: "agnes-1.5-flash", name: "Agnes 1.5 Flash" }, { id: "agnes-2.0-flash", name: "Agnes 2.0 Flash" }] },
