...
export const APIKEY_PROVIDERS = {
  ...
  "alibaba-studio": { id: "alibaba-studio", alias: "alistudio", name: "Alibaba Studio", icon: "cloud", color: "#FF6A00", textIcon: "ALi", website: "https://modelstudio.console.alibabacloud.com", notice: { text: "Alibaba Cloud Model Studio compatible-mode endpoint.", apiKeyUrl: "https://modelstudio.console.alibabacloud.com/?apiKey=1" } },
